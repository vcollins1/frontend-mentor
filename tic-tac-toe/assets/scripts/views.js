export const gameMainMenu = `
    ...
    <section class="mark">
      ...
      <div  class="mark__selector" role="radiogroup">
        <label class="mark__selector--x mark__selector--mark" for="radio-x" tabindex="0">
          <input type="radio" name="mark-selector" id="radio-x" class="mark__selector--radio" checked>
  
          <span role="radio" aria-checked="true" aria-label="select x">
        ...
        <label class="mark__selector--o mark__selector--mark" for="radio-o" tabindex="0">
          <input type="radio" name="mark-selector" id="radio-o" class="mark__selector--radio">
          
          <span role="radio" aria-checked="false" aria-label="select o">
            <svg viewBox="0 0 65 65" width="64" height="64" xmlns="http://www.w3.org/2000/svg">
...
export const gameBoard = `
    <header class="board-header">
        ...
        <div class="turn"  aria-live="polite" aria-atomic="true">
            <div class="turn__img">
                <img src="./assets/images/icon-x-silver.svg" alt="x">
            </div>
            <h1>turn</h1>
        </div>
        <button class="reset reset--btn">
